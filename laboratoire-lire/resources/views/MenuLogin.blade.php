...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div style="margin:150px auto; width:450px;" class="col-xs">      
    <form method="POST" action="{{ route('upload.file') }}" enctype="multipart/form-data" id="fileUploadForm">
                @csrf          
                      <div class="form-group has-warning col-xs-12">
                                <label class="control-label" for="inputWarning1"><i class="fa fa-user"></i>&nbsp;&nbsp; Nom</label>
                                <input type="file" class="form-control" id="inputWarning1" placeholder="Nom" name="file1" autocomplete="off" required>
                      </div>
