...
<div class="col-xs-10">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title">les projets de recherche</h3>
...
<?php 
    $equipes  = DB::select('select projets.titre_projet, projets.domaine_recherche, projets.description, projets.date_creation, projets.avancement, projets.partenaire, equipes.nom from projets, participations, membres, equipes, appartenances where projets.id = participations.id_projet and membres.id = participations.id_membre and membres.id = appartenances.id_membre and equipes.id = appartenances.id_equipe and membres.grade =?', ['CP']);
    foreach($equipes as $equipe){                  
?>
        <tr>
          <td><b><?php  echo $equipe->titre_projet ; ?></b></td>
          <td><b><?php  echo $equipe->nom ; ?></b></td>
          <td><?php  echo $equipe->domaine_recherche ; ?></td>
          <td><?php  echo $equipe->description ; ?></td>
          <td><?php  echo $equipe->date_creation ; ?></td>
          <td>
          <div class="progress progress-xs progress-striped active">
                <div class="progress-bar progress-bar-success" style="width:<?php  echo $equipe->avancement;?>%"></div>
                </div>
          <span class="badge bg-green"><?php  echo $equipe->avancement ; ?>%</span>
          </td>
          <td><?php  echo $equipe->partenaire ; ?></td>
        </tr>
        <?php 
    }                 
?>
