             ...
             ?>
              ...
              <div class="box-group" id="accordion<?php echo $index ;?>">
                ...
                <div class="panel box box-suc">
                 ...
                 <h6>Date debut : <?php echo $manifestation->date ; ?></h6>
                 <h6>Date  fin: <?php echo $manifestation->date_fin ; ?></h6>
...
<div class="col-md-6">
        <div class="callout callout-success">
            <h4>Ajouter une nouvelle Manifestation scientifique</h4>
          </div>
        ...
        <form method="POST"  action="{{ route('Directeur.Manifestation')}}"   id="manifestation">
          ...
          <div class="form-group">
            ...
            <select  class="form-control" id="type" name="type" required>
                ...
                <option>Conf Internationales</option>
                <option>Conf Nationales</option>
                <option>journe d'etude</option>
  ...
  //https://stackoverflow.com/questions/14393512/tinymce-textarea-and-post-form-using-ajax?utm_medium=organic&utm_source=google_rich_qa&utm_campaign=google_rich_qa
         ...
         var data = new FormData(form)
             ...
             //$("#loader").show();
              ...
              $.ajax({
                      type: "POST",
                      url: "{{ route('Directeur.Manifestation')}}",
                      data: data  ,
                      processData: false,    
                      contentType: false,
                      //cache: false,
