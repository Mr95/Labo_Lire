...
<head>
  ...
  <title>LABO LIRE | Consulter projet</title>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">La liste des projets</h3>
                ...
                <tbody>
                 <?php foreach($projets as $projet){  ?>
                  <tr>
                    ...
                    <td><a href="ConsulterProjet/<?php echo $projet->id_projet ; ?>" class="btn btn-info">voir detail &nbsp;&nbsp;<i class="fa fa-info-circle"></i></a></td>
                  </tr>
