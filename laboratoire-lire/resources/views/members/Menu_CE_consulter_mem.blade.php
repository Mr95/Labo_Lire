          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              ...
              foreach($id_equipes as $id_equipe){
                ...
                ?>
              <?php
              $membres =   Illuminate\Support\Facades\DB::select('select membres.id, nom, prenom, grade from membres, appartenances where membres.id = appartenances.id_membre and appartenances.id_equipe = ? ', [$id_equipes2]) ;        
                foreach($membres as $membre){
                  if($membre->id != Session::get('id_CE')){
                ...
                ?>
                 <tr>
                   ...
                   <?php }else{ ?>  
                   <a href="{{ url('Chef_Equipe/ConsulterProfileMembre/'.$membre->id)}}" class="btn btn-block btn-success btn-sm">
                   <i class="fa  fa-folder-open-o"></i> Consulter</a>
                   <?php } ?>  
                   </td>    
                 </tr>
