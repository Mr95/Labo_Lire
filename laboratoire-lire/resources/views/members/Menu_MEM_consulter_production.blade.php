...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <?php  
            $users  = Illuminate\Support\Facades\DB::select('select nom, prenom from membres where id = ?', [Session::get('id_MEM')]);
            ...
            <ul class="dropdown-menu">
              ...
              <img src="../layout/logo.jpg" alt="Cinque Terre" height="125" width="125">
                ...
                ?>
                  <small>
                  <?php  
                   $users  = Illuminate\Support\Facades\DB::select('select grade from membres where id = ?', [Session::get('id_MEM')]);
                  foreach($users as $user){
                  echo $user->grade;
                   }                  
                   ?>
  ...
  <aside class="main-sidebar">
    ...
    <!-- 1ere fonction -->
    <li><a href="../Membre/Profile"><i class="fa fa-home"></i> <span>Profil</span></a></li>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">THE BIG TITLE</h3>
        ...
        <div class="box-body">
            ...
            <p> Les Productions Scientifiques  </p>

 <!--       
<label>Chercher par Intitule</label>
            <input type="text" placeholder="Search By Intitule.."  style="padding: 6px;
            margin-top: 8px;
            margin-bottom: 8px;
            font-size: 17px;
            font-family: verdana;
 ...
 -->
    ...
    <?php 
    /*and rang_auteur =  ,1 ?*/
    $productions  = DB::select('select * from membres , auteurs , production_scientifiques where membres.id = auteurs.id_membre and production_scientifiques.id = auteurs.id_production and membres.id != ? and rang_auteur = ? ', [Session::get('id_MEM'),1]);
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    foreach($productions as $prod){ 
                      ...
                      //$rang_sup = DB::select('select * from auteurs where rang_auteur >  ? and id_membre = ?', [1,Session::get('id_MEM')]);
                ...
                <tr>
                     ...
                     <td><?php  echo $prod->intitule  ; ?></td>
                     <td><?php  echo $prod->nom ; ?></td>
                     <td><?php  echo $prod->type ; ?></td>
                     <td><?php  echo $prod->date ; ?></td>
                     <td><?php  echo $prod->lieu ; ?></td>
                     
                     
                     <?php   $coauteur_ids = explode(',',$prod->demande) ;

                        if(in_array(Session::get('id_MEM'),$coauteur_ids)){ ?>
                         
                            <td>demande envoyé</td>
                     ...
                     <?php   }else{   ?>
                      ...
                      $res = DB::select('select * from auteurs where id_membre = ? and rang_auteur > 1 and id_production = ?', [Session::get('id_MEM'),$prod->id]) ;
                      $ran = '';
                  ...
                  <td> <a href="{{ url('Membre/ConsulterProduction/'.Session::get('id_MEM').'/'.$prod->id_membre.'/'.$prod->id) }}" class="btn btn-block btn-success btn-sm">
                    <i class="fa fa-plus-square"></i>  demander</a></td>
