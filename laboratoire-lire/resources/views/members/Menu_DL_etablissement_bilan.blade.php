		  ...
		  <div class="box box-solid">
            ...
            <div class="box-body">
             ...
             <div class="callout callout-success">
                ...
                <div class="alert alert-success">bilan etabli </div>

                @endif

                @if(Session::get('failed'))

                <div class="alert alert-danger">bilan  non etabli </div>

                @endif

                @if(Session::get('fait'))

                <div class="alert alert-info">operation deja faite </div>
                ...
                <form method="POST"  action="{{ route('Directeur.Bilan')}}"   id="manifestation">
                  ...
                  <div class="form-group">
                        <label class="control-label col-sm-2" >Etablir</label>
                        <div class="col-sm-10"> 
                          <select  class="form-control" name="bilan">
                              <option>non</option>
                              <option>oui</option>
                          </select>
                        </div>
