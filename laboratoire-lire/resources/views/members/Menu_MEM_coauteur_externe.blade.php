  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<!-- 1ere fonction -->
    <li><a href="Profile"><i class="fa  fa-home"></i> <span>Menu</span></a></li>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Ajouter un co-auteur externe </h3>
        ...
        <div class="box-body">
            ...
            @if(Session::get('success'))
              ...
              <div class="alert alert-success">
                 <strong>Success!</strong> Co-auteur externe bien ajouté.
              </div>
           ...
           @if(Session::get('failed'))   
              ...
              <div class="alert alert-danger">
                 <strong>Failed !</strong> Operation echoué.
              </div>
             
           @endif


        <form action="{{ route('Designer.CoauteurExtMEM') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="grade"  name="grade" required placeholder="établissement">
              </div>


            <div class="form-group">
                <label for="etablissement">établissement d'origine  </label>
                <input type="text" class="form-control" id="établissement"  name="etablissement" required placeholder="établissement">
              </div>
              
              <div class="form-group">
                <label for="number">Rang</label>
                <input type="number" class="form-control" id="number"  name="rang" min="1" name="">
              </div>

              <input type="hidden" name="prod" value="<?php echo Session::get('id_prod') ; ?>">
