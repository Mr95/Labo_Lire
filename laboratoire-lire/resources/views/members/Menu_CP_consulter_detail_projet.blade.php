...
<head>
  ...
  <title>LABO LIRE | Detail projet</title>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title  ">Projet <span class="label label-info"><?php echo $etat ; ?></span></h3>
...
<br>
    ...
    <div class="col-sm-2 label label-success" style="font-family:verdana;font-size:13px;">Avencement</div>
    
    <div class="col-sm-10">

    <div class="progress">
        <div class="progress-bar"  role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $avancement ;?>%">
          <?php echo $avancement ;?>%
        </div>
      </div>   
...
<div class="row">
    ...
    <div class="col-sm-2 label label-success " style="font-family:verdana;font-size:13px;">Titre</div>
    ...
    <div class="label label-success col-sm-2" style="font-family:verdana;font-size:13px;">Domaine</div>
...
<div class="row">
    ...
    <div class="label label-success col-sm-2" style="font-family:verdana;font-size:13px;">Date creation</div>
    ...
    <div class="col-sm-4">
      ...
      <div class="label label-success col-sm-2" style="font-family:verdana;font-size:13px;">Date soumission</div>
    ...
    <div class="label label-success col-sm-2" style="font-family:verdana;font-size:13px;">Nombre participant</div>
    ...
    <div class="col-sm-10">
      ...
      <div class="row">
        ...
        <div class="label label-success col-sm-2" style="font-family:verdana;font-size:13px;">Description</div>
        ...
        <div class="label label-success col-sm-2" style="font-family:verdana;font-size:13px;">Partenaire</div>
