      ...
      <!-- 2eme fonction -->
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="ConsulterProduction"><i class="fa fa-users"></i>les productions scientifiques</a></li>
              <li><a href="MesProduction"><i class="fa fa-user"></i>Mes productions scientifiques</a></li>
            </ul>
          </li>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-green">
              ...
              $membres =  DB::select('select * from membres where id = ?', [Session::get('id_MEM')]) ;
                 ...
                 $users = DB::select('select * from users where id = ?', [Session::get('id_MEM_user')]);
                 ...
                 $equipes = DB::select('select id_equipe from appartenances where id_membre = ?', [Session::get('id_MEM')]);
...
<!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next -->
              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  ...
                  <p>
                    ...
                    <form method="POST" id="description" action="{{ route('Membre.Profile')}} "  class="form-horizontal">
 ...
 <!-- /.tab-pane -->
              ...
              <form method="POST" id="production" action="{{ route('Membre.Profile')}} "  class="form-horizontal" enctype="multipart/form-data">
 ...
 <!-- /.tab-pane --> <!-- /.tab-pane -->
  ...
  <!-- /.tab-pane -->
              ...
              <form class="form-horizontal" id="perso"  method='POST' action="{{ route('Membre.Profile')}}" >
