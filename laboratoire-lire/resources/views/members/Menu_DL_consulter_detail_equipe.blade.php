  ...
  <div class="content-wrapper">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-widget widget-user-2">
                ...
                <div class="widget-user-header bg-green">
                  ...
                  $equipes =  DB::select('select * from equipes where id = ?', [Session::get('id_equipe_detail')]) ;
                 
                     foreach($equipes as $equipe){
       
                         $nom = $equipe->nom ;
                         $acronyme = $equipe->acronyme ;
                         $etat = $equipe->etat ;
                    ...
                    /* $count = DB::select('select id_equipe from appartenances where id_membre = ?', [Session::get('id_profil')]);
    ...
    */
                 ...
                 ?>
                  ...
                  <h3 class="widget-user-username"><?php echo $nom ; ?></h3>
                ...
                <div class="box-body box-profile">
                  ...
                  <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                     ...
                     <span class="label label-warning pull-right"  style="font-size:15px;"><?php echo $nom ;  ?></span>
                    </p>
                    </li>
                    ...
                    <li class="list-group-item">
                      <b>Acronyme:</b> 
                     <p>
                     <span class="label label-warning pull-right" style="font-size:15px;"><?php echo $acronyme ;  ?></span>
                    </p>
                    </li>
                    ...
                    <li class="list-group-item">
                      <b>Etat:</b> 
                     <p>
                     <span class="label label-warning pull-right" style="font-size:15px;"><?php echo $etat ;  ?></span>
                    </p>
                    </li>
                    ...
                    <li class="list-group-item">
                      <b>Date creation:</b> 
                      <p>
                     <span class="label label-warning pull-right" style="font-size:15px;"><?php  echo $date_creation ;  ?></span>
                    </p>
                    </li>
    ...
    <!-- /.next --><!-- /.next -->
        ...
        <?php
             ...
             $count = DB::select('select * from appartenances where id_equipe = ?', [Session::get('id_equipe_detail')]);
             ...
             $chef_equipe = DB::select('select * from  appartenances , membres where appartenances.id_membre = membres.id and  appartenances.id_equipe = ? and membres.grade = ?', [Session::get('id_equipe_detail'),'CE']);
        ...
        ?>          
              ...
              <div class="box box-green">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                  <strong><i class="fa fa-book margin-r-5"></i> Chef d'equipe</strong>
                    <p>
                    <span class="label label-danger" style="font-size:15px;">
                        ...
                        <?php
                            ...
                            echo $ceNom . ' ' . $cePreNom ;
                                ...
                                echo "profil chef d'equipe non completé" ;
    ...
    <!-- /.next -->
                  <strong><i class="fa fa-book margin-r-5"></i>Nombre de membre</strong>
                  <p>
                    <span class="label label-danger" style="font-size:15px;">
                    <?php echo $nombre ; ?>
                     </span>
    ...
    <!-- /.next -->
                  <strong><i class="fa fa-map-marker margin-r-5"></i> Nombre de projet</strong>
                  <p>
                    <span class="label label-danger" style="font-size:15px;">
                  ...
                  <strong><i class="fa fa-map-marker margin-r-5"></i> Nombre de projet realisé</strong>
                  <p>
                    <span class="label label-danger" style="font-size:15px;">
                  ...
                  <strong><i class="fa fa-map-marker margin-r-5"></i> Nombre de projet echoué</strong>
                  <p>
                    <span class="label label-danger" style="font-size:15px;">
