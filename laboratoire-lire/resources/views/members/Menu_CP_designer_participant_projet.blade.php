    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Designer Participants aux projets</h3>
                ...
                <tbody>
                 <?php foreach($projets as $projet){  ?>
                  <tr>
                    ...
                    <td><a href="ListeMembre/<?php echo $projet->id_projet ; ?>" class="btn btn-info">Designer membres &nbsp;&nbsp;<i class="fa fa-check-circle"></i></a></td>
                  </tr>
