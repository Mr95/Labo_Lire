    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Choisir les participants</h3>
        ...
        <div class="box-body">
          ...
          <?php
            ...
            $id_projet = Session::get('id_projet_a_designer');
                    ...
                    <td><?php 
                         ...
                         <?php   }else{  ?>
                          ...
                          $id = 0 ;
                             ...
                             $parts = DB::select('select * from projets,participations,membres where projets.id = participations.id_projet and membres.id = participations.id_membre and projets.id = ? and membres.id = ?', [Session::get('id_projet_a_designer'),$membre->id_membre]);
                        ...
                        <a href="DesignerParticipantProjet/<?php echo $membre->id_membre ; ?>/<?php echo Session::get('id_projet_a_designer'); ?>" class="btn btn-info">Designer &nbsp;&nbsp;<i class="fa fa-check-circle"></i></a>
