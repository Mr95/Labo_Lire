...
<head>
  ...
  <title>LABO LIRE | Creer projet</title>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Creer un nouveau projet</h3>
        ...
        <div class="box-body">
          ...
          <form class="form-horizontal" id="creerprojet"  method='POST' action="{{ route('Chef_Projet.CreerProjet')}}" >
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="titre" class="form-control" id="titre" placeholder="Titre de projet" required>
                </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="drecherche" class="form-control" id="dm" placeholder="Domaine de recherche" required>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="code_projet" class="form-control" id="cdprojet" placeholder="Code projet" required>
                </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="date" name="date_creation" class="form-control" id="dm" placeholder="Date creation" required>
                  </div>
                </div>
                ...
                <div  class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="date" name="date_soumission" class="form-control" id="ds" placeholder="Date de soumission" required>
                  </div>
                </div>

              
                <div class="form-group">
                  <label for="ep" class="col-sm-2 control-label">Etat projet</label>
                ...
                <div  class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="number" name="avancement" class="form-control" id="av" min="0" max="100"required>
                    </div>
                  </div>
                  ...
                  <div  class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="partenaire" class="form-control" id="pr" value='aucun' required>
                      </div>
                    </div>
    ...
    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
       ...
       var data = new FormData(form)
           ...
           //$("#loader").show();
            ...
            $.ajax({
                    type: "POST",
                    url: "{{ route('Chef_Projet.CreerProjet') }}",
                    data: data  ,
                    processData: false,    
                    contentType: false,
                    //cache: false,
