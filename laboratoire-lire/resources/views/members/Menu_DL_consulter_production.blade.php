...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Bonjour
        <small>Cher Directeur du labo</small>
      </h1>
      <ol class="breadcrumb">
...
<label>Chercher par Intitule</label>
 ...
 -->
    ...
    <?php 
    /*and rang_auteur =  ,1 ?*/
    $productions  = DB::select('select * from membres , auteurs , production_scientifiques where membres.id = auteurs.id_membre and production_scientifiques.id = auteurs.id_production and membres.id != ? and rang_auteur = ? ', [Session::get('id_DL'),1]);
            ...
            <table class="table table-striped">
                ...
                <tr>
                     ...
                     <?php   $coauteur_ids = explode(',',$prod->demande) ;
                        ...
                        if(in_array(Session::get('id_DL'),$coauteur_ids)){ ?>
                     ...
                     <?php   }else{   ?>
                      ...
                      $res = DB::select('select * from auteurs where id_membre = ? and rang_auteur > 1 and id_production = ?', [Session::get('id_DL'),$prod->id]) ;
                      $ran = '';
                  ...
                  <td> <a href="{{ url('Directeur/ConsulterProduction/'.Session::get('id_DL').'/'.$prod->id_membre.'/'.$prod->id) }}" class="btn btn-block btn-success btn-sm">
