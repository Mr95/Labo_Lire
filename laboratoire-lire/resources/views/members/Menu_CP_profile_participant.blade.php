                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <div class="box box-widget widget-user-2">
                                      ...
                                      <div class="widget-user-header bg-green">
                                        ...
                                        $membres =  DB::select('select * from membres where id = ?', [Session::get('id_participant_a_consulter')]) ;
                                           ...
                                           $equipes = DB::select('select id_equipe from appartenances where id_membre = ?', [Session::get('id_participant_a_consulter')]);
                                      ...
                                      <div class="box-body box-profile">
                                        ...
                                        <ul class="list-group list-group-unbordered">
                                          <li class="list-group-item">
                                           ...
                                           <span class="label label-warning pull-right" style="font-size:13px;"><?php echo $nom ;  ?></span>
                                          </p>
                                          </li>
                                          ...
                                          <li class="list-group-item">
                                            <b>PRENOM:</b> 
                                           <p>
                                           <span class="label label-warning pull-right" style="font-size:13px;"><?php echo $prenom ;  ?></span>
                                          </p>
                                          </li>
                                          ...
                                          <li class="list-group-item">
                                            <b>Email:</b> 
                                           <p>
                                           <span class="label label-warning pull-right" style="font-size:13px;"><?php echo $email ;  ?></span>
                                          </p>
                                          </li>
                                          ...
                                          <li class="list-group-item">
                                            <b>Equipe:</b> 
                                            <p>
                                           <span class="label label-warning pull-right" style="font-size:13px;"><?php  echo $nom_equipe ;  ?></span>
                                          </p>
                                          </li>
                          ...
                          <!-- /.next --><!-- /.next -->
                                    ...
                                    <div class="box box-green">
                                      ...
                                      <div class="box-body">
                                        ...
                                        <p>
                                          <span class="label label-danger" style="font-size:13px;"><?php
