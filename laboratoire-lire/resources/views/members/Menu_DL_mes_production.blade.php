...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    $productions  = DB::select('select * from membres , auteurs , production_scientifiques where membres.id = auteurs.id_membre and production_scientifiques.id = auteurs.id_production and membres.id = ? and rang_auteur = ? order by production_scientifiques.date desc', [Session::get('id_DL'),1]);
...
<table class="table table-striped">
          ...
          ?>
                   ...
                   <tr>
                        ...
                        <td>
                            ...
                            <a href="{{url('Directeur/MesProduction/'. $index1 .'/'.$coauteur[$i].'/'.$prod->id.'/accepter')}}" class="btn btn-success">Accepter</a>
                            <a href="{{url('Directeur/MesProduction/'. $index1 .'/'.$coauteur[$i].'/'.$prod->id.'/refuser')}}" class="btn btn-danger">Refuser</a>
       ...
       <a href="Coauteur_externe/<?php echo $prod->id ; ?>" class="btn btn-info">Ajouter Co-auteur externe</a>
        ...
        <div class="box-footer">
         ...
         $productions1  = DB::select('select * from membres , auteurs , production_scientifiques where membres.id = auteurs.id_membre and production_scientifiques.id = auteurs.id_production and membres.id = ? and rang_auteur > ? order by production_scientifiques.date desc', [Session::get('id_DL'),1]);
