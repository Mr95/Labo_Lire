        ...
        <div class="col-md-6">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-green">
              ...
              $membres =  DB::select('select * from membres where id = ?', [Session::get('id_CP')]) ;
                 ...
                 $users = DB::select('select * from users where id = ?', [Session::get('id_CP_user')]);
                 ...
                 $equipes = DB::select('select id_equipe from appartenances where id_membre = ?', [Session::get('id_CP')]);
...
<!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next -->
              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  ...
                  <p>
                    ...
                    <form method="POST" id="description" action="{{ route('Chef_Projet.Profil')}} "  class="form-horizontal">
 ...
 <!-- /.tab-pane -->
              ...
              <form method="POST" id="production" action="{{ route('Chef_Projet.Profil')}} "  class="form-horizontal" enctype="multipart/form-data">
 ...
 <!-- /.tab-pane --> <!-- /.tab-pane -->
  ...
  <!-- /.tab-pane -->
              ...
              <form class="form-horizontal" id="perso"  method='POST' action="{{ route('Chef_Projet.Profil')}}" >
