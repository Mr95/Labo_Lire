  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa  fa-gears "></i> <span>Gestion du projet</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="Chef_Projet/CreerProjet"><i class="fa fa-gear "></i> création projet</a></li>
            <li><a href="Chef_Projet/ModifierProjet"><i class="fa fa-gear "></i> modifier projet</a></li>
            <li><a href="Chef_Projet/ConsulterProjet"><i class="fa fa-gear "></i> Consulter projet</a></li>
          </ul>
        </li>
		...
		<li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Gestion des membres</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="Chef_Projet/DesignerParticipantProjet"><i class="fa fa-user-plus"></i>désigner les membres</a></li>
            <li><a href="Chef_Projet/ModifierParticipantProjet"><i class="fa fa-user"></i>modifier les membres</a></li>
            <li><a href="Chef_Projet/ConsulterParticipantProjet"><i class="fa fa-user"></i>consulter les membres</a></li>
          </ul>
        </li>
    ...
    <!-- 4eme fonction -->
		<li class="treeview">
      <a href="#">
        <i class="fa fa-edit"></i> <span>Productions scientifiques</span>
        <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
      </a>
      <ul class="treeview-menu">
        <li><a href="Chef_Projet/ConsulterProduction"><i class="fa fa-user-plus"></i>les productions scientifique</a></li>
        <li><a href="Chef_Projet/MesProduction"><i class="fa fa-user"></i>mes productions scientifiques</a></li>
