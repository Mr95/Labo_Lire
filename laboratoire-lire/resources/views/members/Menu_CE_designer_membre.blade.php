          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <?php  
                   $us  = Illuminate\Support\Facades\DB::select('select * from appartenances where id_membre = ?', [Session::get('id_CE')]);
                  foreach($us as $u){
                     $iequipe = $u->id_equipe;
                   }                  
                   ?>
                   ...
                   <!-- /.boocle -->
              <?php 
              $membres =   Illuminate\Support\Facades\DB::select('select * from membres,appartenances where membres.id = appartenances.id_membre and appartenances.id_equipe != ? and grade = ? ', [$iequipe,'MEM']) ;           
                ...
                ?>
                 <tr>
                   ...
                   <?php }else{ ?>  
                   <a href="{{ url('Chef_Equipe/designer_membre/'.$membre->id_membre.'/'.$iequipe)}}" class="btn btn-block btn-success btn-sm">
                   <i class="fa fa-plus-square"></i> designer</a>
                   <?php } ?>  
                   </td>    
