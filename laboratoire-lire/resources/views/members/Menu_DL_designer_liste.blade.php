        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <?php  $equipes =   Illuminate\Support\Facades\DB::select('select * from equipes where id = ? ', [Session::get('teamid')]) ; ?>
              ...
              <h3 class="box-title">desinger <span class="label label-success">chef d'équipe </span></h3>
              <h3 class="box-title">pour l'équipe : <span class="label label-success"><?php echo $acronyme ; ?></span> </h3>
            ...
            <div class="box-body table-responsive no-padding">
             ...
             $membres =   Illuminate\Support\Facades\DB::select('select * from membres where grade = ? or grade = ? ', ['MEM','CP']) ;
               ...
               ?>
                ...
                <tr>
                  ...
                  <a href="{{ url('Directeur/CreeChefEquipefromId/'.$membre->id) }}" class="btn btn-block btn-success btn-sm">
