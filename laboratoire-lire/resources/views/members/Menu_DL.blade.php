           ...
           ?>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                <a href="{{url('Directeur/Profil')}}" class="btn btn-default btn-flat">Profil</a>
                </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- 5eme fonction -->
        <li><a href="Directeur/Manifestation"><i class="fa fa-commenting-o"></i> <span>Manifestations scientifiques</span></a></li>
...
<!-- 6eme fonction -->
        ...
        <ul class="treeview-menu">
          <li><a href="Directeur/ConsulterProduction"><i class="fa fa-users"></i>les productions scientifiques</a></li>
          <li><a href="Directeur/MesProduction"><i class="fa fa-user"></i>Mes productions scientifiques</a></li>
        </ul>
      </li>

		<!-- 7eme fonction -->
        <li><a href="Directeur/Etablissement_Bilan"><i class="fa fa-book"></i> <span>Etablissement du bilan</span></a></li>
