      ...
      <img src="../layout/logo.jpg" alt="Cinque Terre" height="50" width="50">
       <br>
            <div class="box-header with-border">
              <h3 class="box-title"><span class="label label-success">Nouvelle Equipe</span> </h3><br><br>
              <h3 class="box-title"><span class="label label-warning">création d'une nouvelle équipe</span> </h3>          
             <br>
              <br>
            </div>
       <div class="box-body">
          ...
          <div class="col-md-6">
     <form  method="POST" action="{{ route('Directeur.NouvelleEquipe') }}" id="DL_Nouvelle_Equipe" > 
      @csrf     
      <div class="form-group has-warning">
                  <label class="control-label" for="inputWarning"><i class="fa fa-folder-open-o"></i> le nom du l'équipe</label>
                  <input type="text" class="form-control" id="inputWarning" placeholder="Nom"  name="nom"  required>
                </div>
                <div class="form-group has-warning">
                  <label class="control-label" for="inputWarning"><i class="fa fa-asterisk"></i> l'abréviation proposé</label>
                  <input type="text" class="form-control" id="inputWarning" placeholder="Abréviation" name="abreviation" required>
                </div>
             ...
             <!-- Main content -->    <!-- Main content -->    <!-- Main content --> 
                <!-- Main content -->    <!-- Main content -->    <!-- Main content -->
                    <!-- Main content -->    <!-- Main content -->    <!-- Main content --> 
                       <!-- Main content -->    <!-- Main content -->    <!-- Main content -->
                           <!-- Main content -->    <!-- Main content -->    <!-- Main content -->
                               <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->    <!-- Main content -->
  </div>
  <!-- /.content-wrapper -->
...
<script>
  ...
  headers: {
    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
       ...
       $("#send").click(function(event){
        ...
        // le dois voir sa https://stackoverflow.com/questions/199099/how-to-manage-a-redirect-request-after-a-jquery-ajax-call
       // Create an FormData object
     /*  var form = $('#DL_Nouvelle_Equipe')[0];
 ...
 /*           $.ajax({
                    type: "POST",
                    url: "{{ route('Directeur.NouvelleEquipe') }}",
                    data: data  ,
                    processData: false,    
                    contentType: false,*/
                    //cache: false,
