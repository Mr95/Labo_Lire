    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          $membres = DB::select('select * from membres , projets , participations  where projets.id = participations.id_projet and membres.id = participations.id_membre and projets.id = ?  and membres.id != ?', [Session::get('id_projet_a_modifier'),Session::get('id_CP')]);
                       ...
                       <tbody>
                        <?php foreach($membres as $membre){  ?>
                         <tr>
                           ...
                           <td>
                            <?php echo $membre->date_naissance ;?>
                           </td>
                           <td><a href="SupprimerParticipantProjet/<?php echo $membre->id_membre ; ?>/<?php echo $membre->id_projet ; ?>" class="btn btn-danger">Supprimer &nbsp;&nbsp;<i class="fa fa-trash"></i></a>
                           <a href="RemplacerParticipantProjet/<?php echo $membre->id_membre ; ?>/<?php echo $membre->id_projet ; ?>" class="btn btn-success">Remplacer &nbsp;&nbsp;<i class="fa fa-info-circle"></i></a></td>
                         </tr>
