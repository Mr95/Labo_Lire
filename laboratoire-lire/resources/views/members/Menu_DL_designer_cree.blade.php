    ...
    <br><br>
          <div class="box">
             <div class="box-header">
              <h3 class="box-title">Choisir une option</h3>
            </div>
            <div class="box-body">
            <div class="alert alert-success alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-check"></i> Note!</h4>
                 L'équipe est bie creé mais n'a pas un chef d'équipe. veuillez choisir une option  
              </div>
            <div class="col-md-3"></div> 
            <div class="col-md-6">
            <br>
              <div class="form-group has-warning">
                  <label class="control-label" for="inputWarning"><i class="fa fa-check-square"></i> option pour designer chef équipe déja existant</label>
                </div>
              <a href="{{url('Directeur/DesignerListe')}}" class="btn btn-default btn-block bg-orange">Désigner chef d'équipe</a>
              <br>
              <div class="form-group has-warning">
                  <label class="control-label" for="inputWarning"><i class="fa fa-user-plus"></i> option pour creer nouveau chef équipe </label>
                </div>
              <a href="{{url('Directeur/CreeChefEquipe')}}" class="btn btn-default btn-block btn-flat bg-orange">Creer nouveau chef d'équipe </a>
                 <br><br>
            </div>
            <div class="col-md-3"></div>
          </div>
