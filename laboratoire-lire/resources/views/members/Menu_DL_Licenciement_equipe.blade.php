        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <img src="../layout/logo.jpg" alt="Cinque Terre" height="40" width="40">
              <h3 class="box-title">Liste des équipe <span class="label label-success"> actif</span> </h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <!-- /.boocle -->
              <?php    
              $equipes =   Illuminate\Support\Facades\DB::select('select * from equipes where etat = ?', ['actif']) ; 
                ...
                ?>
                 <tr>
                   ...
                   <td> 
                   <a href="{{ url('Directeur/LicenciementEquipe/'.$equipe->id) }}" class="btn btn-block btn-danger btn-sm">
                   <i class="fa fa-minus-square"></i>  licenciement</a>
                   </td>
                 </tr>
               <?php } ?>
                <!-- /.boocle -->
