    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Les Participant projet</h3>
        ...
        <div class="box-body">
          ...
          $membres = DB::select('select * from membres , projets , participations  where projets.id = participations.id_projet and membres.id = participations.id_membre and projets.id = ?', [Session::get('id_projet_a_consulter')]);
                       ...
                       <tbody>
                        <?php foreach($membres as $membre){  ?>
                         <tr>
                           ...
                           <td><a href="ConsulterProfilParticipantProjet/<?php echo $membre->id_membre ; ?>" class="btn btn-info">Consulter participant &nbsp;&nbsp;<i class="fa fa-check-circle"></i></a></td>
                         </tr>
