...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<!-- 1ere fonction -->
        <li><a href="#"><i class="fa fa-commenting-o"></i> <span>Description équipe</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../../index.html"><i class="fa fa-users"></i> les équipes</a></li>
            <li><a href="../../index2.html"><i class="fa fa-user"></i>les membres</a></li>
          </ul>
        </li>
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../../index.html"><i class="fa fa-user-plus"></i> membre simple</a></li>
            <li><a href="../../index2.html"><i class="fa fa-user-plus"></i>désigner membre</a></li>
            <li><a href="../../index2.html"><i class="fa fa-user-plus"></i>désigner chef projet</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Bonjour
        <small>Chef d'équipe XXXXXXXX</small>
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="col-md-4">
          <div class="box box-solid">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">GLSD</span>
				<p>gege lele sou sou dou dou </p>
              <div class="progress">
            ...
            <div class="col-md-12">
              <ul class="list-unstyled">
                <li><b>Description</b>
                	<ul>
                    <li>we are here some bunch of bitches without boobs either pussies but with dicks </li>
                    </ul>
                </li>
                <li><b>ETAT</b>
                  <ul>
            ...
            <div class="col-md-2">
              <a class="btn btn-app">
                <i class="fa fa-edit"></i> Consulter profil
              </a>
            </div>
            </div>
          </div>
