      ...
      <div class="box box-solid">
          ...
          <div class="alert alert-success"  id="alert" style="display:none;" >
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><span class="label label-success">Nouveau chef d'equipe</span> </h3><br><br>
              <h3 class="box-title"><span class="label label-warning">création d'un chef d'équipe</span> </h3>          
             <br>
              <br>
            </div>
            <div class="box-body">
...
<form method="POST" action="{{ route('Directeur.CreeChefEquipe') }}" id="DL_Nouveau_Chef">

  @csrf

        <div class="form-group has-warning">
                  <label class="control-label" for="inputWarning"><i class="fa fa-bell-o"></i> inserer l'adresse e-mail</label>
                  <input type="email" class="form-control" id="inputWarning" placeholder="Email" name="email" autocomplete="off" required>
                </div>
               <!-- <div class="form-group has-warning">
       ...
       var form = $('#DL_Nouveau_Chef')[0];
        var data = new FormData(form)
            ...
            //$("#loader").show();
             ...
             $.ajax({
                     type: "POST",
                     url: "{{ route('Directeur.CreeChefEquipe') }}",
                     data: data  ,
                     processData: false,    
                     contentType: false,
                     //cache: false,
