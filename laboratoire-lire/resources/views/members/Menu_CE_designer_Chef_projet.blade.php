...
<head>
  ...
  <title>LABO LIRE | designer membre</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Désigner membre</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Une liste de tous les membre du labo <span class="label label-success">LIRE</span>
              </h3> 
              <br>
              ...
              <table class="table table-hover">
                <tr>
                  ...
                  <th>Désigner</th>
                   ...
                   <!-- /.boocle -->
              <?php 
              $id_equipes = Illuminate\Support\Facades\DB::select('select id_equipe from  appartenances where id_membre = ? ', [Session::get('id_CE')]) ;
              foreach($id_equipes as $id_equipe){
                $id_equipes2 =$id_equipe->id_equipe;
              }
                ?>
              <?php
              $membres =   Illuminate\Support\Facades\DB::select('select membres.id, nom, prenom, grade from membres, appartenances where membres.id = appartenances.id_membre and appartenances.id_equipe = ?  and membres.id != ?', [$id_equipes2 , Session::get('id_CE')]) ;           
                ...
                ?>
                 <tr>
                   ...
                   <i class="fa fa-plus-square"></i> designer</a>
                   <?php }else{ ?>  

                    <?php if($membre->grade == 'MEM'){ ?>

                      <a href="{{url('Chef_Equipe/DesignerChefProjet/'. $membre->id)}}" class="btn btn-block btn-success btn-sm">
                        <i class="fa fa-plus-square"></i> designer</a>

                    <?php }elseif($membre->grade == 'CP'){ ?>
                      
                      <a href="#" class="btn btn-block btn-info btn-sm">
                        <i class="fa fa-check-circle"></i>Chef de projet </a>
