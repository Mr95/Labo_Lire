...
<head>
  ...
  <title>LABO LIRE | Consulter participant projet</title>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Consulter Participant projet</h3>
                       ...
                       <tbody>
                        <?php foreach($projets as $projet){  ?>
                         <tr>
                           ...
                           <td><a href="ConsulterListParticipantProjet/<?php echo $projet->id_projet ; ?>" class="btn btn-info">Consulter participant &nbsp;&nbsp;<i class="fa fa-check-circle"></i></a></td>
                         </tr>
