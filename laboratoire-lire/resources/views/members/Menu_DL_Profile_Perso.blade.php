        ...
        <div class="col-md-6">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-green">
              ...
              $membres =  DB::select('select * from membres where id = ?', [Session::get('id_DL')]) ;
                 ...
                 $users = DB::select('select * from users where id = ?', [Session::get('id_DL_user')]);
            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>PRENOM:</b> 
                 <p>
                 <span class="label label-warning pull-right" style="font-size:15px;"><?php echo $prenom ;  ?></span>
                </p>
                </li>
                ...
                <li class="list-group-item">
                  <b>Email:</b> 
                 <p>
                 <span class="label label-warning pull-right" style="font-size:15px;"><?php echo $email ;  ?></span>
                </p>
                </li>
...
<!-- /.next --><!-- /.next -->
          ...
          <div class="box box-green">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <strong><i class="fa fa-book margin-r-5" style="font-size:15px;"></i> Etat civil</strong>

              <p>
                <span class="label label-danger" style="font-size:15px;"><?php
...
<!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next --><!-- /.next -->
              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  ...
                  <p>
                    ...
                    <form method="POST" id="description" action="{{ route('Directeur.Profil')}} "  class="form-horizontal">
 ...
 <!-- /.tab-pane -->
              ...
              <form method="POST" id="production" action="{{ route('Directeur.Profil')}} "  class="form-horizontal" enctype="multipart/form-data">
 ...
 <!-- /.tab-pane --> <!-- /.tab-pane -->
  ...
  <!-- /.tab-pane -->
              ...
              <form class="form-horizontal" id="perso"  method='POST' action="{{ route('Directeur.Profil')}}" >
