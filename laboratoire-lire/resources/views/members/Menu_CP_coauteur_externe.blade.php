  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <form action="{{ route('Designer.CoauteurExtCP') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="grade"  name="grade" required placeholder="grade">
              </div>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="number"  name="rang" min="1" >
              </div>
