...
<head>
  ...
  <title>LABO LIRE | modifier participant projet</title>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Modifier participant au projet</h3>
        ...
        <div class="box-body">
          ...
          $projets = DB::select('select * from membres , projets , participations  where projets.id = participations.id_projet and membres.id = participations.id_membre and membres.id = ?', [Session::get('id_CP')]);
                       ...
                       <tbody>
                        <?php foreach($projets as $projet){  ?>
                         <tr>
                           ...
                           <td><?php echo $projet->domaine_recherche ; ?></td>
                           <td><?php echo $projet->nombre_participant ;?></td>
                           <td><?php
                       
                             if($projet->etat == 'En cours'){?>
       
                             <span class="label label-primary"><?php echo $projet->etat ; ?></span>
                               
                             <?php }elseif($projet->etat == 'Completé'){ ?>
                               
                               <span class="label label-success"><?php echo $projet->etat ; ?></span>
       
                             <?php }elseif($projet->etat == 'Echoué'){ ?>
       
                               <span class="label label-danger"><?php echo $projet->etat ; ?></span>
       
                             <?php  }        ?>
                   
                           </td>
                           <td><a href="ModifierListParticipantProjet/<?php echo $projet->id_projet ; ?>" class="btn btn-success">modifier participant &nbsp;&nbsp;<i class="fa fa-info-circle"></i></a></td>
                         </tr>
